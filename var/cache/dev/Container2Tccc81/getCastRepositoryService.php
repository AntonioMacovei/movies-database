...
// Returns the private 'App\Repository\CastRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CastRepository.php';

return $this->privates['App\Repository\CastRepository'] = new \App\Repository\CastRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
