...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CastRepository' => function () {
    return ($this->privates['App\Repository\CastRepository'] ?? $this->load('getCastRepositoryService.php'));
}, 'App\\Repository\\DirectorRepository' => function () {
    return ($this->privates['App\Repository\DirectorRepository'] ?? $this->load('getDirectorRepositoryService.php'));
}, 'App\\Repository\\GalleryRepository' => function () {
    return ($this->privates['App\Repository\GalleryRepository'] ?? $this->load('getGalleryRepositoryService.php'));
}, 'App\\Repository\\GenreRepository' => function () {
    return ($this->privates['App\Repository\GenreRepository'] ?? $this->load('getGenreRepositoryService.php'));
...
}, 'App\\Repository\\MovieRepository' => function () {
    return ($this->privates['App\Repository\MovieRepository'] ?? $this->load('getMovieRepositoryService.php'));
}, 'App\\Repository\\ReviewerRepository' => function () {
    return ($this->privates['App\Repository\ReviewerRepository'] ?? $this->load('getReviewerRepositoryService.php'));
...
}, 'App\\Repository\\ViewingWindowRepository' => function () {
    return ($this->privates['App\Repository\ViewingWindowRepository'] ?? $this->load('getViewingWindowRepositoryService.php'));
}))));
