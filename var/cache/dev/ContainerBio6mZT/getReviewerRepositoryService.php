...
// Returns the private 'App\Repository\ReviewerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ReviewerRepository.php';

return $this->privates['App\Repository\ReviewerRepository'] = new \App\Repository\ReviewerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
