...
// Returns the private 'App\Repository\DirectorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DirectorRepository.php';

return $this->privates['App\Repository\DirectorRepository'] = new \App\Repository\DirectorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
