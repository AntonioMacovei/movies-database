...
// Returns the private 'App\Repository\ViewingWindowRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ViewingWindowRepository.php';

return $this->privates['App\Repository\ViewingWindowRepository'] = new \App\Repository\ViewingWindowRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
